...
const editions = [
    ...
    // Add new editions here following the same format
];
...
function initializeEditions() {
    const currentEdition = editions[editions.length - 1]; // Get latest edition
    
    // Update current edition info
...
function setupContactForm() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        alert('Se abrirá tu cliente de correo para enviar el mensaje. Si no se abre automáticamente, puedes escribir directamente a dm.artefacto@gmail.com');
